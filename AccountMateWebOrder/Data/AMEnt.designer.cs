...
namespace AccountMateWebOrder.Data
{
    ...
    partial void InsertInventoryImage(InventoryImage instance);
    partial void UpdateInventoryImage(InventoryImage instance);
    partial void DeleteInventoryImage(InventoryImage instance);
    ...
    partial void DeleteUnitOfMeasure(UnitOfMeasure instance);
		...
		public System.Data.Linq.Table<InventoryImage> InventoryImages
		{
			get
			{
				return this.GetTable<InventoryImage>();
			}
		}
	...
	public partial class Inventory : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<InventoryImage> _InventoryImage;
    ...
    partial void OnModifiedByChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Inventory_InventoryImage", Storage="_InventoryImage", ThisKey="ID", OtherKey="ID", IsUnique=true, IsForeignKey=false)]
		public InventoryImage InventoryImage
		{
			get
			{
				return this._InventoryImage.Entity;
			}
			set
			{
				InventoryImage previousValue = this._InventoryImage.Entity;
				if (((previousValue != value) 
							|| (this._InventoryImage.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._InventoryImage.Entity = null;
						previousValue.Inventory = null;
					}
					this._InventoryImage.Entity = value;
					if ((value != null))
					{
						value.Inventory = this;
					}
					this.SendPropertyChanged("InventoryImage");
				}
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.InventoryImage")]
	public partial class InventoryImage : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private bool _IsAlwaysGrabFromURL;
    ...
    partial void OnIsAlwaysGrabFromURLChanging(bool value);
    partial void OnIsAlwaysGrabFromURLChanged();
    ...
    partial void OnModifiedByChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_IsAlwaysGrabFromURL", DbType="Bit NOT NULL")]
		public bool IsAlwaysGrabFromURL
		{
			get
			{
				return this._IsAlwaysGrabFromURL;
			}
			set
			{
				if ((this._IsAlwaysGrabFromURL != value))
				{
					this.OnIsAlwaysGrabFromURLChanging(value);
					this.SendPropertyChanging();
					this._IsAlwaysGrabFromURL = value;
					this.SendPropertyChanged("IsAlwaysGrabFromURL");
					this.OnIsAlwaysGrabFromURLChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Inventory_InventoryImage", Storage="_Inventory", ThisKey="ID", OtherKey="ID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
			...
			set
			{
							...
							|| (this._Inventory.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.InventoryImage = null;
					}
					this._Inventory.Entity = value;
					if ((value != null))
					{
						value.InventoryImage = this;
						this._ID = value.ID;
					}
					else
					{
